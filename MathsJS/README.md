...
```
Evaluates an equation. In some specific circumstances `Maths.evaluate` can return better results than `eval` (eg `Maths.evaluate("2^4^8") = 4294967296` whereas `eval("2**4**8") = Infinity`).
Supported operators:
- `+` (add)
- `-` (subtract)
